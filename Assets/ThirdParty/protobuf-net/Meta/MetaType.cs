...
namespace ProtoBuf.Meta
{
    ...
    public class MetaType : ISerializerProxy
    {
        ...
        private ValueMember AddField(int fieldNumber, string memberName, Type itemType, Type defaultType, object defaultValue)
        {
            ...
            if(null != pInfo && pInfo.CanWrite == false)
            //if ((mi as PropertyInfo)?.CanWrite == false)
            {
                ...
                var backingMembers = type.GetMember("<" + pInfo.Name + ">k__BackingField", Helpers.IsEnum(type) ? BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
